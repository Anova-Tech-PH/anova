...
export async function getCertificateConfig(client: SupabaseClient, eventId: string) {
...
export async function getCertificateData(
  ...
  return {
    registration: { id: registration.id, name: registration.name, email: registration.email, status: registration.status },
